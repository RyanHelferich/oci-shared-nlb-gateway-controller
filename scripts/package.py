...
def build(release_file, output):
    ...
    for directory, suffixes in [("api", {".go"}), ("cmd", {".go"}), ("internalcontroller", {".go"}), ("internalgateway", {".go"}), ("internalgatewaypool", {".go"}), ("deploy", {".json", ".yaml"}), ("charts", {".json", ".yaml", ".tpl", ".txt", ".md"}), ("examples", {".md", ".yaml"}), ("docs", {".md", ".drawio", ".png"}), ("Test", {".md"})]:
